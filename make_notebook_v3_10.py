#!/usr/bin/env python3
"""Build autopoiesis_v3_10_preparation_world.ipynb.  Colab-only: sim.py and analysis.py uploaded
alongside, no local paths, no multiprocessing, no run script."""
import json, pathlib

HERE = pathlib.Path(__file__).parent
MD_INTRO = (HERE / "spec_v3_10.md").read_text()
MD_READING = (HERE / "notebook_reading_v3_10.md").read_text()
...
nb = {
    ...
    "metadata": {
        "colab": {"name": "autopoiesis_v3_10_preparation_world.ipynb", "provenance": []},
...
out = HERE / "autopoiesis_v3_10_preparation_world.ipynb"

...
0. **Seeds, before anything else.** This is now the blocking item for both G3 and G4. The
...
1. ~~**G4 mechanic 1's number**~~ — done, and superseded by item 0. The run is against the *stored* G3 seed-0
